...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '94726155133';
...
global.gurl = 'CHATHUN ; // add your username
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '94726155133'; ;
...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;MagellanRaving",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'MR-CHATHUN',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `MR CHATHUN`,
